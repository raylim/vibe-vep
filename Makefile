.PHONY: build test lint clean install download-testdata download-tcga download-grch37 docs docs-build wasm wasm-exec parquet-export cudaops build-cuda bench-cuda gpuhash build-gpuhash bench-gpuhash
